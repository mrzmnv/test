...
<head>
    ...
    <link rel="stylesheet" href="css/syleu.css" />
    <style>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="profile.jpeg" alt="Admin"
                                        class="rounded-circle p-1 bg-warning" width="110">
                                    <div class="mt-3">
                                        <h4><?=$_SESSION['username']?></h4>
                                        <p class="text-secondary mb-1"><?=$_SESSION['user_tel']?></p>
                                        <p class="text-muted font-size-sm">Azerbaijan, Baku</p>
                                    </div>
                                </div>
                                <div class="list-group list-group-flush text-center mt-4">
                                    ...
                                    <a href="session.php" class="list-group-item list-group-item-action border-0">Logout</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="profile-info">
                                ...
                                <p><strong>Email Address:</strong><?=$_SESSION['user_email']?></p>
                                <p><strong>Contact:</strong><?=$_SESSION['user_tel']?></p>
                                <p><strong>Gender:</strong> Man</p>
                                <p><strong>City:</strong> Azerbaijan, Baku</p>
                                <p><strong>Role:</strong> <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1): ?><p>Admin</p><?php else: ?>
    <p>User</p><?php endif; ?></p>
                            </div>
                        </div>
                    </div>
